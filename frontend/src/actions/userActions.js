...
export const login = (email,password) => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.post('/api/users/login',{email,password},config)      //data we get from login page
        dispatch({
...
export const logout = () => (dispatch) => {
    ...
    dispatch({
        type:USER_DETAILS_RESET            //resetting to null all previous data
    })
    dispatch({
...
export const register = (name,email,password) => async(dispatch) =>{
    try {
        ...
        const {data} = await axios.post('/api/users',{name,email,password},config)      //data we get from login page
        dispatch({
...
export const getUserDetails = (id) => async(dispatch, getState) =>{
    try {
        ...
        const {data} = await axios.get(`/api/users/${id}`,config)      //data we get from login page
        dispatch({
...
export const updateUserProfile = (user) => async(dispatch, getState) =>{
    try {
        ...
        const {data} = await axios.put(`/api/users/profile`,user,config)      //data we get from login page
        dispatch({
...
export const listUsers = () => async(dispatch, getState) =>{
    try {
        ...
        const {data} = await axios.get(`/api/users`,config)      //getting all users
        dispatch({
...
export const deleteUser = (id) => async(dispatch, getState) =>{
    try {
        ...
        await axios.delete(`/api/users/${id}`,config)      //delete user
        dispatch({
...
export const updateUser = (user) => async(dispatch, getState) =>{
    try {
        ...
        const {data} = await axios.put(`/api/users/${user._id}`,user,config)      //update user
        dispatch({
            type:USER_UPDATE_SUCCESS,
        })

        dispatch({                                   //send data of updated user
            type:USER_DETAILS_SUCCESS,
            payload:data
        })
